...
const description =
  "A fully offline, open-source transcript-based video editor. Transcribe with Whisper or Parakeet, cut by deleting words, and export with ffmpeg — all in your browser.";
