...
export const WHISPER_MODELS: Record<WhisperModel, WhisperModelInfo> = {
  base: {
    ...
    // decoder_input_ids truncates long-form transcripts.
  },
  small: {
    engine: "whisper",
...
export const PARAKEET_MODELS: Record<ParakeetModel, ParakeetModelInfo> = {
  "parakeet-v2": {
    ...
    label: "Parakeet v2",
    description: "Best English accuracy. Fast WebGPU transcription with native punctuation.",
    size: "~1.3 GB",
  },
  "parakeet-v3": {
    engine: "parakeet",
...
/** Models that can run in the browser transcription worker. */
export const MODELS = {
  ...WHISPER_MODELS,
  ...PARAKEET_MODELS,
...
export function isParakeetModel(value: unknown): value is ParakeetModel {
  return value === "parakeet-v2" || value === "parakeet-v3";
}
